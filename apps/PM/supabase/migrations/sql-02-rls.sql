-- ═══════════════════════════════════════════════════════════════════
-- RtR Control Tower — RLS POLICIES
-- Paste vào: Supabase Dashboard → SQL Editor → New Query → Run
-- ⚠️ Chạy SAU khi sql-01-schema.sql thành công
-- ═══════════════════════════════════════════════════════════════════
...
-- ══════════════════════════════════════════════════════════════
-- PROFILES — view: all, update: own + admin
-- ══════════════════════════════════════════════════════════════
...
-- ══════════════════════════════════════════════════════════════
-- WRITE policies (admin/pm or role-based)
-- ══════════════════════════════════════════════════════════════
...
-- ══════════════════════════════════════════════════════════════
-- AUDIT LOG — read: admin, insert: all authenticated
-- ══════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════
-- ✅ DONE — RLS enabled on 18 tables, 30+ policies created
-- ═══════════════════════════════════════════════════════════════════
