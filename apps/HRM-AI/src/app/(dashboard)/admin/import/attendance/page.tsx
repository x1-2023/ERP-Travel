...
export default function ImportAttendancePage() {
  ...
  const downloadTemplate = () => {
    window.open('/api/admin/import/templates/attendance', '_blank')
  }
  ...
  const handleUpload = async () => {
    ...
    formData.append('importType', 'attendance')
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-sm text-muted-foreground mb-4">Tải file mẫu, điền dữ liệu chấm công theo format: Mã NV, Ngày, Giờ vào, Giờ ra.</p>
