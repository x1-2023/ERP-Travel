...
export async function GET(request: NextRequest) {
  try {
    ...
    const result = await assessmentService.getAssessments(tenantId, { courseId: params.courseId })
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await assessmentService.createAssessment(tenantId, userId, body)
