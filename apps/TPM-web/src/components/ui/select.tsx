...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      // Base
      "flex h-8 w-full items-center justify-between rounded border px-3 py-1.5",
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        "bg-popover border border-surface-border",
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(
      "px-2 py-1.5 text-2xs font-semibold text-foreground-subtle uppercase tracking-wide",
      className
    )}
    {...props}
  />
