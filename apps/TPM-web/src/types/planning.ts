...
// Internal types for planning module (to avoid conflicts with main types)
type PlanningPromotionType = string;
...
interface PlanningBaseline {
  id: string;
  name: string;
  salesPerDay?: number;
}

interface PlanningPromotion {
  id: string;
  code: string;
  name: string;
  type: string;
...
export interface ScenarioParameters {
  promotionType: PlanningPromotionType;
...
export interface ClashDetection {
  id: string;
  promotionId: string;
  promotion?: PlanningPromotion;
  clashWithId: string;
  clashWith?: PlanningPromotion;
  clashType: ClashType;
