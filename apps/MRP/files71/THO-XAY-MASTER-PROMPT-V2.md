...
#                    "Industrial Precision" + "Excel-Like" Experience
#
#                    Version: 2.0
#                    Date: 2026-01-14
...
# ⭐⭐⭐ QUAN TRỌNG NHẤT - ĐỌC TRƯỚC KHI LÀM BẤT CỨ ĐIỀU GÌ ⭐⭐⭐

## 📊 TRIẾT LÝ "EXCEL-LIKE" - HIỂU NGƯỜI DÙNG

```
╔══════════════════════════════════════════════════════════════════════════════════════╗
║                                                                                      ║
║   🎯 MỤC TIÊU SẢN PHẨM: THAY THẾ EXCEL TRONG QUẢN LÝ SẢN XUẤT                       ║
║                                                                                      ║
║   NGƯỜI DÙNG CỦA CHÚNG TA:                                                          ║
║   ┌────────────────────────────────────────────────────────────────────────────┐    ║
║   │  • Nhân viên kế toán/kế hoạch: 10+ năm dùng Excel                          │    ║
║   │  • Quản lý sản xuất: Quen với spreadsheet, sợ phần mềm mới                 │    ║
║   │  • Thủ kho: Cần nhập liệu nhanh, không muốn học giao diện lạ              │    ║
║   │  • Giám đốc: Xem báo cáo như Excel, không muốn đổi thói quen               │    ║
║   └────────────────────────────────────────────────────────────────────────────┘    ║
║                                                                                      ║
║   → NẾU GIAO DIỆN KHÁC EXCEL QUÁ NHIỀU = NGƯỜI DÙNG TỪ CHỐI SỬ DỤNG               ║
║   → NẾU GIAO DIỆN GIỐNG EXCEL = NGƯỜI DÙNG CẢM THẤY "Ồ, GIỐNG Y NHƯ EXCEL!"       ║
║                                                                                      ║
╚══════════════════════════════════════════════════════════════════════════════════════╝
```
...
## 🔒 QUY TẮC "EXCEL-FIRST" - KHÔNG ĐƯỢC VI PHẠM

```
┌──────────────────────────────────────────────────────────────────────────────────────┐
│                                                                                      │
│   ✅ PHẢI GIỮ NGUYÊN (Giống Excel):           ❌ KHÔNG ĐƯỢC LÀM:                     │
│                                                                                      │
│   • Bảng = GRID cells rõ ràng                 • Chuyển table → card layout           │
│   • Header cố định khi scroll                 • Ẩn cột không hỏi user                │
│   • Click header → Sort (▲▼)                  • Xóa chức năng sort                   │
│   • Số căn PHẢI + font monospace              • Số căn trái hoặc font thường         │
│   • Grid lines/borders hiển thị               • Xóa border cells                     │
│   • Row hover highlight                       • Đổi thứ tự columns                   │
│   • Checkbox chọn nhiều dòng                  • Đổi tên headers                      │
│   • Tab để di chuyển giữa cells               • Đổi format số (1,234.56)             │
│   • Double-click để edit (nếu có)             • Xóa filter functionality             │
│                                                                                      │
└──────────────────────────────────────────────────────────────────────────────────────┘
```
...
```
1. GIỮ NGUYÊN trải nghiệm EXCEL-LIKE (tables, sort, filter, grid)
2. KHÔNG thay đổi cấu trúc tables (columns, order, data mapping)
3. KHÔNG xóa features đang hoạt động
4. KHÔNG đổi tech stack
5. Gặp conflict → BÁO CÁO, không tự quyết định
6. Commit TỪNG BƯỚC, message rõ ràng
```
...
| **Triết lý UX** | **EXCEL-LIKE: Giao diện quen thuộc như Excel** |
...
## Mục tiêu: Áp dụng theme "Industrial Precision" VÀ giữ "Excel-Like" experience
...
### 2.13 Update Table Styling (⚠️ EXCEL-FIRST - CRITICAL!)

```
╔══════════════════════════════════════════════════════════════════════════════════════╗
║                                                                                      ║
║   🔒 EXCEL-LIKE TABLE RULES - ĐỌC KỸ TRƯỚC KHI SỬA                                  ║
║                                                                                      ║
║   NGƯỜI DÙNG EXCEL MONG ĐỢI:                                                        ║
║   ┌────────────────────────────────────────────────────────────────────────────┐    ║
║   │  • Bảng có GRID LINES rõ ràng (như ô Excel)                                │    ║
║   │  • Header CỐ ĐỊNH khi scroll xuống (Freeze Panes)                          │    ║
║   │  • Click header → SORT ngay (▲▼)                                           │    ║
║   │  • SỐ căn PHẢI + font đều (để nhìn thẳng hàng)                            │    ║
║   │  • Row HIGHLIGHT khi hover (dễ theo dõi dòng)                              │    ║
║   │  • CHECKBOX để chọn nhiều dòng                                             │    ║
║   │  • Columns KHÔNG TỰ ĐỘNG ẨN (user quen vị trí cột)                        │    ║
║   └────────────────────────────────────────────────────────────────────────────┘    ║
║                                                                                      ║
║   → NẾU THIẾU BẤT KỲ FEATURE NÀO = USER NÓI "EXCEL LÀM ĐƯỢC MÀ CÁI NÀY KHÔNG?"    ║
║                                                                                      ║
╚══════════════════════════════════════════════════════════════════════════════════════╝
```
...
```tsx
// Table container - GIỮ GRID LINES như Excel
className="w-full border-collapse text-[13px] font-body"

// Table header - STICKY như Freeze Panes của Excel
...
// Table cell - CÓ BORDER như ô Excel
className="p-2 border border-mrp-border bg-transparent"

// Numeric cell - QUAN TRỌNG: giống Excel = căn PHẢI + MONOSPACE
className="p-2 border border-mrp-border bg-transparent text-right font-mono"

// Row hover - Giống highlight row trong Excel
...
**⚠️ CHECKLIST EXCEL-LIKE - PHẢI ĐẢM BẢO:**

```
□ Grid lines hiển thị (borders trên mọi cell)
□ Header sticky khi scroll
□ Click header → sort hoạt động
□ Sort indicator (▲▼) hiển thị
□ Số căn phải
□ Số dùng font monospace (thẳng hàng)
□ Row hover highlight
□ Checkbox selection hoạt động
□ Column order KHÔNG đổi
□ Column names KHÔNG đổi
□ Number format giữ nguyên (1,234.56)
```
...
- Xóa grid lines/borders

### 2.14 Test Tables (EXCEL-LIKE VERIFICATION)

```bash
npm run dev
```

**Kiểm tra TỪNG module như một user Excel:**

```
┌─────────────────────────────────────────────────────────────────────────────────┐
│  MODULE         │ COLUMNS    │ SORT    │ FILTER  │ NUMBERS   │ GRID LINES     │
├─────────────────────────────────────────────────────────────────────────────────┤
│ Parts           │ □ Đúng     │ □ OK    │ □ OK    │ □ Phải    │ □ Hiển thị     │
│ BOM             │ □ Đúng     │ □ OK    │ □ OK    │ □ Phải    │ □ Hiển thị     │
│ Work Orders     │ □ Đúng     │ □ OK    │ □ OK    │ □ Phải    │ □ Hiển thị     │
│ Purchase Orders │ □ Đúng     │ □ OK    │ □ OK    │ □ Phải    │ □ Hiển thị     │
│ Inventory       │ □ Đúng     │ □ OK    │ □ OK    │ □ Phải    │ □ Hiển thị     │
│ Quality         │ □ Đúng     │ □ OK    │ □ OK    │ □ Phải    │ □ Hiển thị     │
│ MRP             │ □ Đúng     │ □ OK    │ □ OK    │ □ Phải    │ □ Hiển thị     │
└─────────────────────────────────────────────────────────────────────────────────┘
```
...
```bash
git add .
git commit -m "style(ui): Apply Industrial theme to tables (EXCEL-LIKE preserved)

- Dark theme colors applied
- Grid lines preserved (like Excel cells)
- Sticky headers preserved (like Freeze Panes)
- Monospace font for numbers (right-aligned)
- Sort/filter functionality verified
- All columns and data mapping unchanged
- Excel users will feel at home"
```
...
export function Modal({ isOpen, onClose, title, children, size = 'md' }: ModalProps) {
  // ESC to close - giống Excel dialog
...
interface ConfirmDialogProps {
  ...
  title: string
  message: string
  confirmText?: string  // "Xóa" / "Xác nhận" - tiếng Việt
  cancelText?: string   // "Hủy" / "Đóng" - tiếng Việt
...
// Toast messages - Tiếng Việt thân thiện
  ...
  return (
    <div className="flex items-center justify-center min-h-[400px]">
      <div className="flex flex-col items-center gap-3">
        ...
        <span className="text-sm text-mrp-text-muted">Đang tải dữ liệu...</span>
      </div>
    </div>
  )
}
...
// Tiếng Việt thân thiện cho user Excel
const defaultDescriptions = {
  inbox: 'Chưa có dữ liệu nào. Bắt đầu bằng cách thêm mới.',
  search: 'Không tìm thấy kết quả phù hợp. Thử từ khóa khác.',
  file: 'File không tồn tại hoặc đã bị xóa.',
}
...
- Vietnamese text for user-friendly experience"
```
...
## Mục tiêu: Kiểm tra EXCEL-LIKE experience và deploy
...
### 4.3 Manual QA Checklist - EXCEL-LIKE VERIFICATION

```
╔══════════════════════════════════════════════════════════════════════════════════════╗
║                                                                                      ║
║   🔍 QA CHECKLIST - TEST NHƯ MỘT USER EXCEL                                         ║
║                                                                                      ║
║   Hãy tưởng tượng bạn là một nhân viên kế toán đã dùng Excel 10 năm.               ║
║   Bạn mong đợi phần mềm mới hoạt động TƯƠNG TỰ như Excel.                           ║
║                                                                                      ║
╚══════════════════════════════════════════════════════════════════════════════════════╝
...
TABLES (CRITICAL - EXCEL-LIKE):
┌─────────────────────────────────────────────────────────────────────────────────────┐
│  Kiểm tra từng bảng như một user Excel:                                            │
│                                                                                     │
│  □ Grid lines hiển thị? (Giống ô Excel)                                           │
│  □ Header sticky khi scroll? (Giống Freeze Panes)                                 │
│  □ Click header → sort? (Giống Excel)                                             │
│  □ Sort indicator ▲▼ hiển thị?                                                     │
│  □ Số căn phải? (Chuẩn kế toán)                                                   │
│  □ Số thẳng hàng? (Font monospace)                                                │
│  □ Hover row → highlight? (Dễ theo dõi)                                           │
│  □ Checkbox chọn nhiều dòng?                                                       │
│  □ Columns đúng thứ tự?                                                            │
│  □ Format số đúng? (1,234.56)                                                      │
└─────────────────────────────────────────────────────────────────────────────────────┘

□ Parts: PASS / FAIL (ghi chú nếu fail)
□ BOM: PASS / FAIL
...
□ Validation hiển thị đúng (tiếng Việt)
□ Submit hoạt động
...
```bash
git add .
git commit -m "chore: QA fixes and polish - Excel-like experience verified

- Fix any remaining styling issues
- Update E2E test selectors
- Verify all Excel-like features working
- Tables feel familiar to Excel users"
```
...
- [ ] **QUAN TRỌNG:** Tables vẫn "cảm thấy như Excel"
...
# ═══════════════════════════════════════════════════════════════════════════════
#                  APPENDIX C: EXCEL-LIKE TABLE PRESERVATION RULES
# ═══════════════════════════════════════════════════════════════════════════════

```
╔══════════════════════════════════════════════════════════════════════════════════════╗
║                                                                                      ║
║   🔒 QUY TẮC EXCEL-LIKE - KHÔNG ĐƯỢC VI PHẠM                                        ║
║                                                                                      ║
║   TẠI SAO QUAN TRỌNG?                                                               ║
║   ───────────────────────────────────────────────────────────────────────           ║
║   Người dùng MRP đã quen Excel 5-15 năm. Họ:                                        ║
║   • Biết chính xác cột nào ở đâu                                                    ║
║   • Quen click header để sort                                                       ║
║   • Mong đợi số căn phải, text căn trái                                            ║
║   • Cần grid lines để đọc dữ liệu                                                   ║
║                                                                                      ║
║   → Thay đổi bất kỳ điều gì = User nói "Không thích, quay lại Excel!"              ║
║                                                                                      ║
║   ⚠️ TUYỆT ĐỐI KHÔNG:                                                               ║
║   ───────────────────────────────────────────────────────────────────────           ║
...
║   • Text colors                                                                     ║
║   • Hover effects                                                                   ║
║   • Font family (giữ monospace cho số)                                             ║
...
### Table không giống Excel nữa

```
⚠️ NẾU USER PHÀN NÀN "KHÔNG GIỐNG EXCEL":

□ Kiểm tra grid lines còn không?
□ Số có căn phải không?
□ Số có font monospace không?
□ Header có sticky không?
□ Sort có hoạt động không?

→ Nếu thiếu bất kỳ điều gì → ROLLBACK ngay và fix
```
...
#  Ngày: 2026-01-14
#  Version: 2.0 (Enhanced Excel-Like emphasis)
#
#  TRIẾT LÝ CỐT LÕI:
#  ─────────────────
#  "Người dùng đã quen Excel 10 năm.
#   Phần mềm mới phải CẢM THẤY như Excel,
#   chỉ là ĐẸP HƠN và THÔNG MINH HƠN."
#
#  Khi hoàn thành, báo cáo lại cho Chủ nhà:
#  - Số commits đã tạo
#  - Các vấn đề đã fix
#  - Kết quả QA (đặc biệt Excel-like checklist)
#  - Link production
#
# ═══════════════════════════════════════════════════════════════════════════════
